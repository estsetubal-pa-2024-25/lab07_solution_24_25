...
public class UniversityNetworkView extends BorderPane implements UniversityNetworkUI {
    ...
    private Label lblPeopleIsolated;
    ...
    private void updateStatistics() {
       ...
       lblPeopleIsolated.setText(model.getIsolated().toString());
    }
    ...
    public void setTriggers(UniversityNetworkController controller) {
        ...
        btRemovePerson.setOnAction(event -> {
            Alert alert = makeConfirmationDialog("Delete Person", "Are you sure?");
            alert.showAndWait().ifPresent(response -> {
    ...
    public void clearControls() {
        ...
        this.txtPersonName.clear();
        this.txtRelationshipDescription.clear();
    ...
    private VBox createSidePanel() {
        ...
        Label labelIsolated = new Label("Isolated Persons: ");
        labelIsolated.setStyle("-fx-font-weight: bold;");
        lblMostPopular = new Label("");
        lblPeopleCount = new Label("");
        lblPeopleIsolated = new Label("");
        VBox statsPane = new VBox(labelCount, lblPeopleCount,
                labelPopular, lblMostPopular, labelIsolated,lblPeopleIsolated);
